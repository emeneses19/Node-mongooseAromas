...
//================================
// app.put('/tipohabitacion/:id', (req, res) => {
//     let id = req.params.id;
//     let body = req.body;
...
//         descripcion: body.descripcion
//     }
//     Tipohabitacion.findByIdAndUpdate(id, nombTipohabitacion, descTipohabitacion, { new: true, runValidators: true }, (err, tipohabitacionDB) => {
//         if (err) {
//             return res.status(500).json({
//                 ok: false,
//                 err
...
// ============================
// app.delete('/tipohabitacion/:id', (req, res) => {
